...
Table* Logins=Zast->MClient->CreateTable(this, Zast->ServerName, Zast->VDB[Zast->GetIDDBName("Опасности")].ServerDB);
...
Table* Group=Zast->MClient->CreateTable(this, Zast->ServerName, Zast->VDB[Zast->GetIDDBName("Опасности")].ServerDB);
...
Zast->MClient->WriteDiaryEvent("Hazards","Пароль принят","");
...
{
Zast->MClient->WriteDiaryEvent("Hazards","Неверный пароль","Pass="+EdPass->Text);
Zast->MClient->DeleteTable(this, Group);
Zast->MClient->DeleteTable(this, Logins);
Zast->MClient->Stop();
Zast->Start=false;
