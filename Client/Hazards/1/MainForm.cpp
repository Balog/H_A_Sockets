...
Territoriya->Active=true;
ComboBox1->Text=Territoriya->FieldByName("Наименование территории")->Value;
...
{
Zast->MClient->WriteDiaryEvent("Hazards ошибка","Ошибка синхронизации территорий"," Ошибка "+IntToStr(GetLastError()));
}
}
//---------------------------------------------------------------------------
...
{
Zast->MClient->WriteDiaryEvent("Hazards ошибка","Ошибка синхронизации деятельностей","");
}
}
//---------------------------------------------------------------------------
...
{
Zast->MClient->WriteDiaryEvent("Hazards ошибка","Ошибка синхронизации воздействий","");
}
}
//---------------------------------------------------------------------------
...
ComboBox1->Text=Tab->FieldByName("Наименование территории")->AsString;
