...
__published:	// IDE-managed Components
        ...
        TAction *PrepReport2;
        TAction *StopDemoNoPodr;
        TAction *ZaprosSaveAspectsMspes;
        TAction *CompareMSpecAspects0;
        TAction *PrepReport1Mspec;
        TAction *PrepReport2Mspec;
        TAction *ContSvodReportAct;
        TAction *CreateMainSvod;
        ...
        void __fastcall StopDemoNoPodrExecute(TObject *Sender);
        void __fastcall ZaprosSaveAspectsMspesExecute(TObject *Sender);
        void __fastcall CompareMSpecAspects0Execute(TObject *Sender);
        void __fastcall PrepReport1MspecExecute(TObject *Sender);
        void __fastcall PrepReport2MspecExecute(TObject *Sender);
        void __fastcall ContSvodReportActExecute(TObject *Sender);
        void __fastcall CreateMainSvodExecute(TObject *Sender);
