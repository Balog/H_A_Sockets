...
String PAspect=Path+"Templates\\Hazards.dtb";
String PRefs=Path+"Templates\\HReference.dtb";

String RDiary=Path+"Result\\Diary.dtb";
String RAspect=Path+"Result\\Hazards.dtb";
String RRefs=Path+"Result\\HReference.dtb";
 ...
 */
  ...
  AspectsTo->FieldByName("Ситуация")->Value=AspectsFrom->FieldByName("Ситуация")->AsInteger;


  AspectsTo->FieldByName("Вид территории")->Value=EncodeBranch("Ветви_5", AspectsFrom->FieldByName("Вид территории")->AsInteger);//AspectsFrom->FieldByName("Вид территории")->Value;
  AspectsTo->FieldByName("Деятельность")->Value=EncodeBranch("Ветви_6", AspectsFrom->FieldByName("Деятельность")->AsInteger);
  ...
  AspectsTo->FieldByName("Аспект")->Value=EncodeBranch("Ветви_7", AspectsFrom->FieldByName("Аспект")->AsInteger);
  AspectsTo->FieldByName("Воздействие")->Value=EncodeBranch("Ветви_3", AspectsFrom->FieldByName("Воздействие")->AsInteger);
  AspectsTo->FieldByName("G")->Value=AspectsFrom->FieldByName("G")->Value;
  AspectsTo->FieldByName("O")->Value=AspectsFrom->FieldByName("O")->Value;
  AspectsTo->FieldByName("R")->Value=AspectsFrom->FieldByName("R")->Value;
  AspectsTo->FieldByName("S")->Value=AspectsFrom->FieldByName("S")->Value;
  AspectsTo->FieldByName("T")->Value=AspectsFrom->FieldByName("T")->Value;
  AspectsTo->FieldByName("L")->Value=AspectsFrom->FieldByName("L")->Value;
  AspectsTo->FieldByName("N")->Value=AspectsFrom->FieldByName("N")->Value;
  AspectsTo->FieldByName("Z")->Value=AspectsFrom->FieldByName("Z")->Value;
  AspectsTo->FieldByName("Значимость")->Value=AspectsFrom->FieldByName("Значимость")->Value;
