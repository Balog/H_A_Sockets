...
//Pass->Show();
 ...
 Zast->MClient->ReadTable("Àñïåêòû","Select Login, Code1, Code2, Role from Logins Where Role<>1", "Select Login, Code1, Code2, Role From TempLogins");
...
switch (Role)
{
 ...
 case 3:
 {
 Form1->Caption="Ïîëüçîâàòåëü: "+Login;
 Form1->Show();
 break;
 }
 case 4:
 {
 Form1->Caption="Äåìîíñòðàöèîííûé ïîëüçîâàòåëü: "+Login+"                ***ÇÀÏÈÑÜ ÍÀ ÑÅÐÂÅÐ ÎÒÊËÞ×ÅÍÀ***";
 Form1->Show();
 break;
 }
}
