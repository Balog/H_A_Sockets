...
//Variant Book1=App1.OlePropertyGet("Workbooks").OleFunction("Add", PP1.c_str());
...
{
G="select * from TempAspects Where Подразделение="+IntToStr(NumPodrazd)+" AND "+Filtr1+" Order By [Номер аспекта]";
}
