...
{
Zast->MClient->WriteDiaryEvent("NetAspects ошибка","Сбой сохранения аспектов","");
...
{
Zast->MClient->WriteDiaryEvent("NetAspects ошибка","Сбой подготовки к записи аспектов","");
