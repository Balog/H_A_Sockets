...
Ret=false;
//Application->MessageBoxA("Архивирование невозможно.\nОтсутствует модуль Resurs.dat\n\nПрограмма продолжает работу", "Архивирование базы данных", MB_ICONERROR|MB_OK|MB_TOPMOST);
...
Patch=pPathBackup+"\\"+pNameDB+" от "+Name;
//Patch="D:\\"+Name;
...
if(H == INVALID_HANDLE_VALUE)
{
 ...
 String S1="Произошла ошибка при очистке архива: "+S;
Application->MessageBoxA(S1.c_str(), "Очистка архива", MB_ICONEXCLAMATION|MB_OK|MB_TOPMOST);
